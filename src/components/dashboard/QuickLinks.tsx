      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {links.map(({ href, label, icon: Icon }) => (
          <Link
            key={href}
            href={href}
            className="group flex items-center gap-3 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-4 elev-1 elev-interactive hover:border-[var(--primary)]/40 hover:bg-[var(--surface-hover)]"
          >
